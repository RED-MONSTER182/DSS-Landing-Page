      ...
      <header className="border-b bg-white"> 
        <div className="container flex h-16 items-center justify-between px-4">
          <Link href="/" className="flex items-center space-x-2">
            ...
            />
            <span className="text-xl weight-bold  text-black">DSS</span>
          </Link>
      ...
      <main className="flex-1 bg-white"> 
        ...
        <section className="container px-10 py-10 md:py-26 bg-white"> 
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-gray-500 md:text-xl">
              A student driven community that aims the best of the community. Join us to explore, innovate, and grow in the tech
              world.
            </p>
            <button 
        ...
        <section className="container px-4 py-12 md:py-24 bg-white"> 
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="max-w-[900px] mx-auto text-gray-500 md:text-xl">
              At DSS, we believe in the power of technology to transform lives and communities. Our mission is to foster a
              collaborative environment where students can enhance their skills, connect with industry experts, and work on
              real-world projects. Together, we inspire creativity and innovation!
            </p>
          </div>
        ...
        <section className="container px-4 py-12 md:py-24 bg-white"> 
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-gray-500 md:text-xl">
              Hear from our members who have turned their ideas into successful projects through DSS. Their journeys reflect the
              passion and innovation fostered within our community.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
            {[1, 2, 3].map((i) => (
              <div key={i} className="rounded-lg border hover:border-yellow-500 bg-white p-6 transition-all hover:shadow-lg"> {/* Confirmed bg-white */}
                <div className="flex items-center space-x-4">
                  <Image
                ...
                <p className="mt-4 text-gray-500">
                  Joining DSS has been a transformative experience for me. The hands-on projects and collaborative environment
                  have helped me sharpen my coding skills and build real-world applications. I&apos;ve made lifelong friends and
                  mentors here!
                </p>
              </div>
            ))}
